...
const scalaDebugger = __importStar(require("./debugger/scalaDebugger"));
...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        const serverVersion = (0, getServerVersion_1.getServerVersion)(config, context);
...
function launchMetals(outputChannel, context, metalsClasspath, serverProperties, javaConfig, serverVersion) {
    ...
    return client.start().then(() => {
        var _a, _b;
        const doctorProvider = new doctor_1.DoctorProvider(client, context);
        let stacktrace;
        function getStacktracePanel() {
            if (!stacktrace) {
                ...
                stacktrace.iconPath = {
                    light: vscode_1.Uri.file(path.join(context.extensionPath, "icons", "exception-light.svg")),
                    dark: vscode_1.Uri.file(path.join(context.extensionPath, "icons", "exception-dark.svg")),
                };
        ...
        [
            ...
            metals_languageclient_1.ServerCommands.ScalaCliStart,
            metals_languageclient_1.ServerCommands.ScalaCliStop,
        ...
        registerCommand(metals_languageclient_1.ClientCommands.StartDebugSession, (param) => {
        ...
        registerCommand(metals_languageclient_1.ClientCommands.StartRunSession, (param) => {
        ...
        const istTestManagerDisabled = !vscode_1.tests || getTestUI() === "Code Lenses";
