    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function showPanel(version, releaseNotesUrl) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                panel.iconPath = vscode.Uri.file(path_1.default.join(context.extensionPath, "icons", "scalameta-logo.png"));
...
function getReleaseNotesMarkdown(releaseNotesUrl, context, asWebviewUri) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const renderedNotes = marked_1.marked.parse(releaseNotes);
