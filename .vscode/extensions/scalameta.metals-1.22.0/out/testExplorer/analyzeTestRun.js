...
function analyzeTestCases(run, result, testCases, parent) {
    var _a;
    const parentName = (parent === null || parent === void 0 ? void 0 : parent.id) || "";
 ...
 */
function createTestCasesMap(testSuiteResult, parentName) {
    const tuples = testSuiteResult.tests.map((test) => {
